...
const App = () => {
  ...
  return (
    <div>
      ...
      <Button handleClick={incremateVote} text="Vote" />
      <Button handleClick={selectAnecdotes} text="Next Anecdotes" />
      <Header text="Anecdote with most votes" />
      <Display anecdotes={anecdotes[points.indexOf(highestVotes)]} />
